...
class _CvCreateSheetState extends State<CvCreateSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final targets = cubit.state.targets;
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(l10n.cvCreate, style: Theme.of(context).textTheme.titleLarge),
              ...
              if (targets.isEmpty)
                Padding(
                  ...
                  child: Text(l10n.cvSelectTargetFirst,
              ...
              DropdownButtonFormField<String>(
                ...
                onChanged: (v) => setState(() => _templateId = v ?? 'nexoraMinimal'),
              ),
