...
class VerifyEmailScreen extends StatefulWidget {
  const VerifyEmailScreen({super.key, this.email = 'you@example.com'});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: AmbientBackground(
        child: SafeArea(
          child: _verified ? const _VerifiedSplash() : _buildForm(context),
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      child: TextField(
        ...
        maxLength: _VerifyEmailScreenState._length,
